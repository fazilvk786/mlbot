...
const ow = 'FAZIL VK';
const nomorowner = '+19795001362';
const ovo = '+19795001362';
const pulsa = '+19795001362';
...
╠════════════════════` , MessageType.text);
  ...
  if (text.includes('.Say')) {
    conn.sendMessage(id, 'Please repeat the command in lowercase\n_Example : .say Arjunarz_', MessageType.text, { quoted: m });
  }
  if (text.includes(".say")) {
  ...
  if (text.includes('.Sand1')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .sand1 Arjunarz_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand1')) {
  ...
  if (text.includes('.Sand2')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .sand2 arjun_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand2')) {
  ...
  if (text.includes('.Metal')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .metal Arjunarz_', MessageType.text, { quoted: m });
  }
  if (text.includes('.metal')) {
  ...
  if (text.includes('.Old')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .old Cyberkallan_', MessageType.text, { quoted: m });
  }
  if (text.includes('.old')) {
  ...
  if (text.includes('.Coding')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .coding Arz_', MessageType.text, { quoted: m });
  }
  if (text.includes('.coding')) {
  ...
  if (text.includes('.Neon4')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .neon4 Arjunarz_', MessageType.text, { quoted: m });
  }
  if (text.includes('.neon4')) {
...
Zulu = zu` , MessageType.text, { quoted: m });
  ...
  if (text.includes('.Rate')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .rate seberapa ganteng lexa_', MessageType.text, { quoted: m });
  ...
  if (text.includes('.Heart')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .heart Arjun_', MessageType.text, { quoted: m });
  }
  if (text.includes('.heart')) {
  ...
  if (text.includes('.Grass')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .grass Arz_', MessageType.text, { quoted: m });
  }
  if (text.includes('.grass')) {
    ...
    axios.get(`https://tobz-api.herokuapp.com/api/photooxy?theme=message_under_the_grass&text=${teks}&apikey=${tobzkey}`)
      .then((res) => {
        imageToBase64(res.data.result)
          .then(
            (ress) => {
              conn.sendMessage(id, '[ WAIT ] Creating Text⏳ silahkan tunggu', MessageType.text, { quoted: m })
              var buf = Buffer.from(ress, 'base64')
              conn.sendMessage(id, buf, MessageType.image, { quoted: m })
            })
      })
  ...
  if (text.includes('.Pubg')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .pubg Arjun_', MessageType.text, { quoted: m });
  }
  if (text.includes('.pubg')) {
    ...
    axios.get(`https://tobz-api.herokuapp.com/api/photooxy?theme=shadow&text=${teks}&apikey=${tobzkey}`)
      .then((res) => {
        imageToBase64(res.data.result)
          .then(
            (ress) => {
              conn.sendMessage(id, '[ WAIT ] Creating Tect⏳ silahkan tunggu', MessageType.text, { quoted: m })
              var buf = Buffer.from(ress, 'base64')
              conn.sendMessage(id, buf, MessageType.image, { quoted: m })
            })
      })
  ...
  if (text.includes('.Logopornhub')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .logopornhub Lexa/nime_', MessageType.text, { quoted: m });
  }
  if (text.includes('.logopornhub')) {
  ...
  if (text.includes('.Ninja')) {
    ...
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .ninja Lexa/nime_', MessageType.text, { quoted: m });
    ...
    axios.get(`https://terhambar.com/aw/qts/?kata=${kata}&author=${author}&tipe=rain`)
      .then((res) => {
        imageToBase64(res.data.result)
          .then(
            (ress) => {
              conn.sendMessage(id, '[ WAIT ] Creating quotes⏳ silahkan tunggu', MessageType.text, { quoted: m })
              var buf = Buffer.from(ress, 'base64')
              conn.sendMessage(id, buf, MessageType.image, { quoted: m })
            })
      })
  ...
  if (text.includes('.Couple')) {
    conn.sendMessage(id, 'Please repeat the command with lowercase \n_example : .couple Lexa & udan_', MessageType.text, { quoted: m });
  }
  if (text.includes('.couple')) {
...
╠ _Ex = .Couple Arjun & Sree_ 
╠≽️ *.Getzodiak (Name &OfOf Birthdayl)
╠ _Ex : .Getzodiak Arjun & 09-09-2002_ 
...
╚════════════════════`, MessageType.text, { quoted: m });
  ...
  if (messageType === MessageType.text) {
    let is = m.message.conversation.toLocaleLowerCase()
    if (is == '.gombal') {
      fetch('https://raw.githubusercontent.com/cyberkallanyt/chunni-bot/main/random-scraper/main/random/Globel.txt')
        .then(res => res.text())
        .then(body => {
          let tod = body.split("\n");
          let pjr = tod[Math.floor(Math.random() * tod.length)];
  ...
  if (messageType === MessageType.text) {
    let is = m.message.conversation.toLocaleLowerCase()
    if (is == '.receh') {
      fetch('https://raw.githubusercontent.com/cyberkallanyt/chunni-bot/main/random-scraper/main/random/Receh.txt')
        .then(res => res.text())
        .then(body => {
          let tod = body.split("\n");
          let pjr = tod[Math.floor(Math.random() * tod.length)];
  ...
  if (messageType === MessageType.text) {
    let is = m.message.conversation.toLocaleLowerCase()
    if (is == '.truth') {
      fetch('https://raw.githubusercontent.com/cyberkallanyt/chunni-bot/main/random-scraper/main/random/Truth.txt')
        .then(res => res.text())
        .then(body => {
          let tod = body.split("\n");
          let pjr = tod[Math.floor(Math.random() * tod.length)];
  ...
  if (messageType === MessageType.text) {
    let is = m.message.conversation.toLocaleLowerCase()
    if (is == '.dare') {
      fetch('https://raw.githubusercontent.com/cyberkallanyt/chunni-bot/main/random-scraper/main/random/dare.txt')
        .then(res => res.text())
        .then(body => {
          let tod = body.split("\n");
          let pjr = tod[Math.floor(Math.random() * tod.length)];
  ...
  if (messageType === MessageType.text) {
    let is = m.message.conversation.toLocaleLowerCase()
    if (is == '.statpack') {
      fetch('https://raw.githubusercontent.com/cyberkallanyt/chunni-bot/main/random-scraper/main/random/Status.txt')
        .then(res => res.text())
        .then(body => {
          let tod = body.split("\n");
          let pjr = tod[Math.floor(Math.random() * tod.length)];
  ...
  if (text.includes('.tod')) {
    var url = "https://raw.githubusercontent.com/cyberkallanyt/chunni-bot/main/Scrap/Img/tod/todscarp.png";
    axios.get(url).then((res) => {
      imageToBase64(url)
        .then(
          (ress) => {
